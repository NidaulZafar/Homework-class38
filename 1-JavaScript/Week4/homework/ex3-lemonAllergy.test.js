...
let nonAllergicFruits = [];
// ! Function under test
function sanitizeFruitBasket(fruitBasket, forbiddenFruit) {
  nonAllergicFruits = fruitBasket.filter((fruit) => fruit !== forbiddenFruit);
  return nonAllergicFruits;
  }
...
describe('sanitizeFruitBasket', () => {
  ...
  test('should return a new array that does not include the unwanted `lemon`', () => {
    // TODO replace next line with your code
    expect(nonAllergicFruits).not.toContain("lemon");
  });
});
